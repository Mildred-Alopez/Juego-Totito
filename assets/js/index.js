...
let limpiarbtn1 = document.querySelector('.Reiniciar-1')
let limpiarbtn2 = document.querySelector('.Reiniciar-2')
let contador1 = 0;
let contador2 = 0;
let flag = true
...
celdas.forEach((celdas) => {
    limpiarbtn1.addEventListener('click', () => {
        celdas.innerText = ''
...
limpiarbtn2.addEventListener('click', () => {
    contador1 = 0
    contador2 = 0
    pantalla1.value = ''
    pantalla2.value = ''
